void settaggio() {
  int segno = -1; // adifferenza della SX  qui metto il segno vediamo se basta cambiarlo solo qui ( motore ed encoder rimangono uguali)
  ...
  if (digitalRead(A5) == HIGH) { 
    ...
    for ( int i = 70; i < 1200; i = i + 2) {
      md.setM2Speed(i * motore  * 1 * segno);
      tensione = i;
      if ( Targhet(50)) {
